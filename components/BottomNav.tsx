...
const BottomNav: React.FC = () => {
  ...
  const activeClass = "text-brand-light scale-110";
  const inactiveClass = "text-gray-400";

  return (
    <footer className="fixed bottom-0 left-0 right-0 h-16 bg-gray-900/80 backdrop-blur-sm border-t border-gray-700 z-50">
